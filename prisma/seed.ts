  ...
  const sampleResources = await Promise.all([
    prisma.resource.create({
      data: {
        ...
        metadata: {
          ...
          compatibility: ['2021.3', '2022.3', '2023.2'],
          dependencies: [],
          fileSize: '125MB',
          assetCount: 156
        },
        previews: [
          { type: 'image', url: '/preview1.jpg' },
          { type: 'image', url: '/preview2.jpg' }
        ],
    ...
    prisma.resource.create({
      data: {
        ...
        previews: [
          { type: 'image', url: '/blender-preview1.jpg' }
        ],
    ...
    prisma.resource.create({
      data: {
        ...
        metadata: {
          resolution: '2x, 3x',
          format: 'Figma, Sketch, PSD',
          license: 'MIT',
          componentCount: 200,
          styleGuide: true
        },
        previews: [
          { type: 'image', url: '/ui-preview1.jpg' },
          { type: 'image', url: '/ui-preview2.jpg' }
        ],
